...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link rel="stylesheet"  href="style/Needers.css"/>
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; text-align:center;">Blood Needers</h1>
        <div id="labels">
            <br />
        ...
        <asp:DropDownList ID="DropDownList3" runat="server" Height="35px" Width="100%">
            ...
            <asp:ListItem>AB-</asp:ListItem>
                ...
                Blood-Packet:
        <asp:TextBox ID="TextBox4" runat="server" Height="35px" Width="100%" placeholder="1"></asp:TextBox>
                Hospital:
        <asp:TextBox ID="TextBox5" runat="server" Height="35px" Width="100%" placeholder="Hospital Name"></asp:TextBox>
            </div>
            <div class="right-box">
                Attendee:
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" Height="35px" Width="100%">
            ...
            <asp:ListItem>Quetta</asp:ListItem>
                 ...
                 Blood-Quantity:
        <asp:TextBox ID="TextBox3" runat="server" Height="35px" Width="100%" placeholder="1 bottle"></asp:TextBox>
                Phone:
        <asp:TextBox ID="TextBox7" runat="server" MaxLength="11" placeholder="03xxxxxxxxx" Height="35px" Width="100%"></asp:TextBox>
                Hos-Branch:
        <asp:TextBox ID="TextBox6" runat="server" placeholder="Karachi, etc" Height="35px" Width="100%"></asp:TextBox>
            </div>
