<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmAdminREG_SELF-DON.aspx.cs" Inherits="blood_bucket.Admin.frmAdminREG_SELF_DON" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="text-align:center; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">SELF DONOR's DETAILS</h1>
    <br />
        <div class="dropDown">
            <div id="labels">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" BackColor="DarkRed" BorderColor="DarkRed" ForeColor="White" Width="70px" Height="30px" Text="Delete" />
    </div>
       <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" BackColor="DarkRed" BorderColor="DarkRed" ForeColor="White" Width="100px" Height="30px" Text="Show All" />
