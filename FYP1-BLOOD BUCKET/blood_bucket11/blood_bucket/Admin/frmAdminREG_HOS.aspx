<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmAdminREG_HOS.aspx.cs" Inherits="blood_bucket.Admin.frmAdminREG_HOS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="text-align:center; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">HOSPITAL's DETAILS</h1>
    <br />
        <div id="labels">
