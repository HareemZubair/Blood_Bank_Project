<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmAdminPanel.aspx.cs" Inherits="blood_bucket.Admin.frmAdminPanel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="home-header">
       <div id="header"></div>
        ...
        <div id="main">
       <h1 style="text-align:center; font-size:40px; margin-top:40px; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Admin Panel</h1>
           <br /><br />
            <h3 style="color:black; text-align:center; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
            As the company has to manage it, there will be a web based online Admin dashboard for that.<br /> 
            Admin dashboard will be password protected and admin specific only. <br />
            Not the usual client will be able to access it. <br />
            Admin can then maintain the databases and provide the clients with the help and guidelines as well. <br />
            The frequesnt ups and downs in all stuff will all be set by the Admin only.<br /></h3><br />
        </div>
        </div>
</asp:Content>
