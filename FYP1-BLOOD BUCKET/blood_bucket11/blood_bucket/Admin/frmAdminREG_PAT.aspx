<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmAdminREG_PAT.aspx.cs" Inherits="blood_bucket.Admin.frmAdminREG_PAT" %>
...
<link rel="stylesheet" href="../style/AdminPanels.css" />
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="text-align:center; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">PATIENT's DETAILS</h1>
    <br />
        <div id="labels">
    ...
    <div id="dvScreenWidth" visible="false">
            ...
            <div class="gridset">
        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="mygrdContent" PagerStyle-CssClass="pager" HeaderStyle-CssClass="hdr" RowStyle-CssClass="rows">
        </asp:GridView>
    </div>
                </div>
            </div>
