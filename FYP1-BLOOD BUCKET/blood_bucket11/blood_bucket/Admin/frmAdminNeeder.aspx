<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmAdminNeeder.aspx.cs" Inherits="blood_bucket.Admin.frmAdminNeeder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="text-align:center; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">NEEDER's DETAILS</h1>
    <br />
        <div id="labels">
    ...
    <div class="mx-auto">
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" display="flex" align-content="center" Text="Show All" BackColor="DarkRed" BorderColor="DarkRed" ForeColor="White" Width="100px" Height="30px" />
    </div><br />
