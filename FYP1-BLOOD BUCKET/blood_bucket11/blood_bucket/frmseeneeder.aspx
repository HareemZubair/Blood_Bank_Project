...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="home-header">
        ...
        <div id="main">
        <h1 style="text-align:center; color:darkred; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Blood Needers</h1><br />
    <div class="dropDown">
        Blood-Group :
        ...
        <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="DarkRed" OnClick="LinkButton3_Click" Width="25px">Submit</asp:LinkButton> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       City:
        <asp:DropDownList ID="DropDownList2" runat="server" Height="35px" Width="20%">
        </asp:DropDownList>
        <asp:LinkButton ID="LinkButton4" runat="server" ForeColor="DarkRed" OnClick="LinkButton4_Click" Width="25px">Submit</asp:LinkButton>
    </div><br /><br />
