...
namespace blood_bucket
{
    public partial class frmselfdon_reg : System.Web.UI.Page
    {
        ...
        {
            if (TextBox1.Text == "" || TextBox2.Text == "" || DropDownList1.SelectedItem.Text == "" || DropDownList2.SelectedItem.Text == "" || DropDownList3.SelectedItem.Text == "" || TextBox3.Text == "" || TextBox4.Text == "" || DropDownList4.Text == "" || DropDownList5.Text == "" || TextBox5.Text == "" || TextBox6.Text == "" || TextBox7.Text == "" || TextBox8.Text == "" || TextBox9.Text == "")
            {
            ...
            else
            {
                ...
                if (chk == false)
                {
                    ...
                    qry = "select * from don_reg where don_user_id='" + TextBox8.Text + "' or don_user_pass = '" + TextBox9.Text + "'";
